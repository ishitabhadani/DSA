...
public class probs_on_functional_recursion {
    public static void main(String[] args) {
        ...
        // int n = arr.length;
        // reverse.rev_arr(0, arr, n-1);
        // System.out.println(Arrays.toString(arr));
        // reverse.reverse_array(0, arr, n);
        // System.out.println(Arrays.toString(arr));

        // String s = "madam";
        // String str = "hello";
        // System.out.println(palindrome.palindrome_string(0,s,s.length()));//true
        // System.out.println(palindrome.palindrome_string(0,str,str.length()));//false
    }
